...
function LandingPage() {
  ...
  // useEffect(() => {
  //   console.log("I am always called on each state/component rerenders")
  // });

  // useEffect(() => {
  //   console.log("I am only called when this component is first time mounted")
  //   setTimeout(() => {
  //     setLoading(false)
  //   }, 3000)
  ...
  // useEffect(() => {
  //   console.log("I am always called when loading state is manupulated")
  // })
  return (
      ...
      <section className="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-16">
        <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
          ...
          <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <a href="/category/computer-office" className="flex items-center rounded-lg border border-gray-200 bg-white px-4 py-2 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
